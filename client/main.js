...
var $author$project$Doc$Doc = F2(
	function (docId, textarea) {
		return {docId: docId, textarea: textarea};
	});
var $author$project$Doc$DocId = function (a) {
	return {$: 'DocId', a: a};
};
var $author$project$Doc$Textarea = F3(
	function (value, cursorPos, newContent) {
		return {cursorPos: cursorPos, newContent: newContent, value: value};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Doc$init = function (_v0) {
	var textarea = A3($author$project$Doc$Textarea, '', 0, '');
	return _Utils_Tuple2(
		A2(
			$author$project$Doc$Doc,
			$author$project$Doc$DocId(1),
			textarea),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Doc$CursorRec = function (a) {
	return {$: 'CursorRec', a: a};
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Doc$cursorPosReceiver = _Platform_incomingPort('cursorPosReceiver', $elm$json$Json$Decode$int);
var $author$project$Doc$subscriptions = function (_v0) {
	return $author$project$Doc$cursorPosReceiver($author$project$Doc$CursorRec);
};
...
var $author$project$Doc$zipper = F3(
	function (xxs, yys, acc) {
		zipper:
		while (true) {
			if (!yys.b) {
				return acc;
				...
				if (xxs.b) {
					...
					var xs = xxs.b;
					if (!_Utils_eq(x, y)) {
						var $temp$xxs = A2($elm$core$List$cons, x, xs),
							$temp$yys = ys,
					...
					return A2(
						$elm$core$Debug$log,
						'this shouldn\'t to happen, xs is [], ys:',
						A2($elm$core$List$cons, y, ys));
				}
			}
		}
	});
var $author$project$Doc$addedContent = F2(
	function (oldString, newString) {
		var o = $elm$core$String$toList(oldString);
		var n = $elm$core$String$toList(newString);
		return $elm$core$String$fromList(
			A3($author$project$Doc$zipper, o, n, _List_Nil));
	});
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Doc$cursorPosition = _Platform_outgoingPort(
	'cursorPosition',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Doc$Delete = {$: 'Delete'};
var $author$project$Doc$Insert = {$: 'Insert'};
var $author$project$Doc$detectUserInp = F2(
	function (oldStr, newStr) {
		return (_Utils_cmp(
			$elm$core$String$length(oldStr),
			$elm$core$String$length(newStr)) > 0) ? $author$project$Doc$Delete : $author$project$Doc$Insert;
	});
var $author$project$Doc$updateTextarea = F2(
	function (doc, newStr) {
		var oldStr = doc.textarea.value;
		var cursPos = doc.textarea.cursorPos;
		var _v0 = A2($author$project$Doc$detectUserInp, oldStr, newStr);
		if (_v0.$ === 'Insert') {
			return _Utils_Tuple2(
				_Utils_update(
					doc,
					{
						textarea: A3(
							$author$project$Doc$Textarea,
							newStr,
							cursPos,
							A2($author$project$Doc$addedContent, oldStr, newStr))
					}),
				$author$project$Doc$cursorPosition(_Utils_Tuple0));
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					doc,
					{
						textarea: A3($author$project$Doc$Textarea, newStr, cursPos, '')
					}),
				$author$project$Doc$cursorPosition(_Utils_Tuple0));
		}
	});
var $author$project$Doc$update = F2(
	function (typ, doc) {
		if (typ.$ === 'Change') {
			var str = typ.a;
			return A2($author$project$Doc$updateTextarea, doc, str);
		} else {
			var pos = typ.a;
			return _Utils_Tuple2(
				_Utils_update(
					doc,
					{
						textarea: A3($author$project$Doc$Textarea, doc.textarea.value, pos, doc.textarea.newContent)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Doc$Change = function (a) {
	return {$: 'Change', a: a};
};
...
var $author$project$Doc$styledFlexBox = A2(
...
var $author$project$Doc$styledH1 = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$hex('#957dad')),
...
var $author$project$Doc$styledSection = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Doc$styledTextarea = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Doc$viewDocument = function (model) {
	return A2(
		$author$project$Doc$styledSection,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				$author$project$Doc$styledH1,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('shadow-sm')
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Collaborative text editor')
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(
								$author$project$Doc$styledFlexBox,
								_List_Nil,
								_List_fromArray(
									[
										A2(
										$author$project$Doc$styledTextarea,
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Type your text here...'),
												$rtfeldman$elm_css$Html$Styled$Attributes$value(model.textarea.value),
												$rtfeldman$elm_css$Html$Styled$Attributes$rows(15),
												$rtfeldman$elm_css$Html$Styled$Attributes$cols(100),
												$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Doc$Change),
												$rtfeldman$elm_css$Html$Styled$Attributes$id('docTextarea')
											]),
										_List_Nil)
									]))
							]))
...
var $author$project$Doc$view = function (model) {
	var _v0 = A2($elm$core$Debug$log, 'doc model:', model);
	return $author$project$Doc$viewDocument(model);
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$Doc$init,
		subscriptions: $author$project$Doc$subscriptions,
		update: $author$project$Doc$update,
		view: A2($elm$core$Basics$composeR, $author$project$Doc$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
